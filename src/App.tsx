const App = () => {
  return (
    <main className="w-[min(100%-2rem_,60rem)] mx-auto grid items-center h-[100vh]">
      <h1 className="text-[clamp(28px_,5vw_,40px)] text-center">
        Em construção...
      </h1>
      <div className="grid place-items-center ml-[-84px]">
        <div className="max-w-[100px] animate-[spin-right_5s_linear_0s_infinite]">
          <img
            src="/assets/gear1.svg"
            alt="Purple gear rotating to the right side"
          />
        </div>
        ...
        <div className="max-w-[100px] animate-[spin-left_5s_linear_0s_infinite] mt-[-55px] mr-[-159px]">
          <img
            ...
            alt="Desaturated purple gear rotating to the left side"
          />
        </div>
      </div>
